...
@Schema
data class EtherscanLikeNFTTransaction(
        ...
        @JsonProperty("tokenID") @Schema(title = "Token ID") var tokenID: String,
        @JsonProperty("tokenValue") @Schema(title = "Amount Transferred") var tokenValue: String?,
